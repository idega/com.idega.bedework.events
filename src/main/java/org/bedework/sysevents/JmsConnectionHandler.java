...
//  private boolean debug;
  ...
  public void open(final String queueName) throws NotificationException {
    try {
      ...
      try {
    	  connFactory = (javax.jms.ConnectionFactory) ctx.lookup(
      ...
      try {
        ...
        */
        ...
        ourQueue = jmsch.getActiveMQQueue(queueName, "bedework." + queueName);
//        try {
...
//        }
        ...
        if (ourQueue == null) {
            throw new NotificationException(t);
        		...
        		getLogger().warn("New queue is created with name: " + ourQueue.getQueueName() 
