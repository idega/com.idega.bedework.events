 ...
 */
public abstract class JmsSysEventListener implements MessageListener,
		ExceptionListener, JmsDefs {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1668614881752912463L;
