...
public class BwSysevLogger extends LogListener implements BwSysevLoggerMBean {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6211014407263965588L;
	...
	/*
	 * an example say's we need this - we'll see public MBeanInfo getMBeanInfo()
	 * throws Exception { InitialContext ic = new InitialContext(); RMIAdaptor
	 * server = (RMIAdaptor) ic.lookup("jmx/rmi/RMIAdaptor");
	 * 
	 * ObjectName name = new ObjectName(MBEAN_OBJ_NAME);
	 * 
	 * // Get the MBeanInfo for this MBean MBeanInfo info =
	 * server.getMBeanInfo(name); return info; }
	 */
